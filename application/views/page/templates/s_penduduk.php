<section class="page-section">
    <div class="container">
        ...
        <div class="text-center">
            <h2 class="section-heading text-uppercase">PENCARIAN INFORMASI KEPENDUDUKAN</h2>
        ...
        <div class="text-justify pl-5 pr-5">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <label for="nama">Asal Universitas / Sekolah *</label>
                    <?= form_input(['name' => 'nama', 'id' => 'nama', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan asal sekolah/universitas']); ?>
                </div>
                <div class="col-lg-6">
                    <label for="nama">Jurusan *</label>
                    <?= form_input(['name' => 'nama', 'id' => 'nama', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan jurusan']); ?>
                </div>
                <div class="col-lg-6">
                    <label for="nik">Tanggal *</label>
                    <?= form_input(['name' => 'nik', 'id' => 'nik', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan tanggal']); ?>
                </div>
                ...
                <div class="col-lg-6 mt-2">
                    <label for="jenis">Pilih Pengajuan *</label>
