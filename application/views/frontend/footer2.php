        ...
        <!-- Contact form JS-->
        <script src="<?= base_url()?>vendor/admin/assets/mail/jqBootstrapValidation.js"></script>
        <script src="<?= base_url()?>vendor/admin/assets/mail/contact_me.js"></script>
        <!-- Core theme JS-->
        <script src="<?= base_url()?>vendor/admin/assets/js/scripts2.js"></script>
        <script src="<?= base_url();?>vendor/admin/assets/jquery-ui-1.12.1/jquery-ui.js"></script>
