<section class="page-section">
    <div class="container">
        ...
        <div class="text-justify pl-5 pr-5">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <label for="nik">Nama Universitas *</label>
                    <?= form_input(['name' => 'nik', 'id' => 'nik', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan nama universitas anda']); ?>
                </div>
                <div class="col-lg-6">
